...
// INSERT YOUR CODE HERE
let change = document.getElementById("duration-button");
function changeDuration(){
  let text = document.getElementById("duration-text");
  let new_duration = prompt("Enter your number");
  text.innerHTML = new_duration;
  duration = new_duration;
  recalculate();}
change.addEventListener("click",changeDuration);